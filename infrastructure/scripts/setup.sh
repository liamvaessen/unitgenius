...
# echo -e "\n\n${PURPLE}[UnitGenius Setup Tool]:${NC} ${YELLOW}Creating service principal for AKS cluster...${NC}"
...
# echo -e "\n\n${PURPLE}[UnitGenius Setup Tool]:${NC} ${GREEN}Created service principal for AKS cluster.${NC}"
